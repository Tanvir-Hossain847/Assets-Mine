      ...
      <div className="relative overflow-hidden rounded-3xl border bg-card/30 p-8 text-center backdrop-blur-sm sm:p-16 lg:p-24">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
            <Button size="lg" className="h-14 rounded-full px-8 text-lg font-bold shadow-md active:scale-95 transition-all duration-200">
              <Link href="/" className="flex items-center">
                 Explore the Marketplace
                 <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="h-14 rounded-full px-8 text-lg font-bold border-primary/20 hover:bg-primary/10 active:scale-95 transition-all duration-200">
              Sell Your Assets
            </Button>
          </div>
        </div>
